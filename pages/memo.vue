<templete>
    <section class="container">
        ...
        <tr>
            <th>Title</th>
            <td><input type="text" name="title" class="class" size="40" v-model="title" @focus="set_flg">
            <button @click="find">find</button>
            </td>
        </tr>
        <tr>
            <th>Memo</th>
            <td><textarea name="content" class="content" cols="50" rows="5" v-model="content">
            </textarea></td>
        </tr>
        <tr>
            <th></th>
    ...
    methods:{                
        ...
        remove:function(){
            if(this.sel_flg == false){
                ...
                this.$store.commi("memo/remove",this.sel_flg);
                this.set_flg();
            }
        },
        find: function(){
